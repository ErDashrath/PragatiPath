...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-r5#d&nq!%e+cbnh$iczyglun@btvif@*+d0ho^a@m3j2&bxei8')
...
if config('DEBUG', default=True, cast=bool):
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='adaptive_learning'),
...
# CORS Configuration - Enhanced for React Frontend
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
    "http://localhost:5000",  # Express/TSX server
    "http://127.0.0.1:5000",
